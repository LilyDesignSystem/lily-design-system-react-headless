...
A React 19 component that renders a native `<input type="text">` for entering Norway's Fødselsnummer.
...
- Use `NorgeFodselsnummerView` for the read-only display counterpart.
