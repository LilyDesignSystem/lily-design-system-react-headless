...
- Accepts an optional `children` ReactNode for content inside the circle (e.g., percentage text)
...
- `children`: ReactNode (default: `undefined`) -- optional content rendered inside (e.g., percentage text)
