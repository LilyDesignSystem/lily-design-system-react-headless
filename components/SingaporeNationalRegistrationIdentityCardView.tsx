...
//
// A headless display component for showing Singapore's
// National Registration Identity Card Number / Foreign Identification Number (NRIC/FIN) in a read-only format.
...
export interface SingaporeNationalRegistrationIdentityCardViewProps {
    className?: string;
...
export default function SingaporeNationalRegistrationIdentityCardView({
    className = "",
    label,
    value = "",
    ...restProps
}: SingaporeNationalRegistrationIdentityCardViewProps) {
    return (
        <span
        className={`singapore-national-registration-identity-card-view ${className}`}
        aria-label={label}
