...
- Uses `useState()` to track the tree element reference for keyboard navigation
...
- `children`: ReactNode (required) -- tree item elements, expected to be `<li role="treeitem">` elements
