...
- Maintains a `treeRef` via `useRef` to query tree items for keyboard navigation
...
- `children`: ReactNode (required) -- tree item elements with `role="treeitem"` to render inside the list
