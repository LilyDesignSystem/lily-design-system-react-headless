...
- The `value` prop supports controlled component usage for the selected rating value (1-5, with 0 meaning no selection)
...
- `value`: number (default: `0`) -- current rating (1-5, 0 = none), controlled via `value + onChange`
...
<FiveFaceRatingPicker label="How was your experience?" value + onChange />

{/* Custom face labels for localization or different scales */}
<FiveFaceRatingPicker label="Rate service" value + onChange labels={["Terrible", "Poor", "Fair", "Great", "Excellent"]} />

{/* Disabled face rating */}
<FiveFaceRatingPicker label="Previous rating" value={4} disabled />

{/* Custom name for form submission */}
<FiveFaceRatingPicker label="Satisfaction" value + onChange name="satisfaction" />
```
