...
describe("CyprusNationalPassportNumberInput", () => {
    ...
    test("can be set to required", () => {
        render(<Subject label="National Passport Number" required />);
    ...
    test("can be set to disabled", () => {
        render(<Subject label="National Passport Number" disabled />);
    ...
    test("passes through additional HTML attributes", () => {
        render(<Subject label="National Passport Number" data-testid="subject" />);
