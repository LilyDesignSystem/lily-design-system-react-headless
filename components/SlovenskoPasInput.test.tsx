...
import Subject from "./SlovenskoPasInput";
...
describe("SlovenskoPasInput", () => {
    ...
    test("can be set to required", () => {
        render(<Subject label="Slovak Passport" required />);
    ...
    test("can be set to disabled", () => {
        render(<Subject label="Slovak Passport" disabled />);
    ...
    test("passes through additional HTML attributes", () => {
        render(<Subject label="Slovak Passport" data-testid="subject" />);
