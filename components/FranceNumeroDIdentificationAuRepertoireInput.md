...
- Pattern is defined as a constant to avoid template expression parsing of curly braces
...
```tsx
<FranceNumeroDIdentificationAuRepertoireInput label="NIR" value={nir} onChange={setNir} />
```
